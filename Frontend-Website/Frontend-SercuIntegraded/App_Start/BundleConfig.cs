namespace Frontend_SercuIntegraded
{
    using System.Web.Optimization;
    using Frontend_SercuIntegraded.Constants;
    ...
    public static class BundleConfig
    {
        ...
        private static void AddCss(BundleCollection bundles)
        {
            ...
            // Our website stylesheets
            bundles.Add(new StyleBundle(
                "~/Content/news-site/css")
                .Include("~/Content/news-site/css/*.css"));
        }
        ...
        private static void AddJavaScript(BundleCollection bundles)
        {
            ...
            // Our website stylesheets
            Bundle newsSiteCoreBundle = new ScriptBundle("~/bundles/news-site")
                .Include("~/Scripts/news-site/js/*.js")
                .Include("~/Scripts/news-site/js/common/*.js");
            bundles.Add(newsSiteCoreBundle);
        }
    }
}
