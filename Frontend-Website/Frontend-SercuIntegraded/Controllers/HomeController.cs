namespace Frontend_SercuIntegraded.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        static readonly string NewsConnectionString =
            ConfigurationManager.ConnectionStrings["FrontendDbContext"].ConnectionString;
        readonly IBrowserConfigService browserConfigService;
        readonly IFeedService feedService;
        readonly IManifestService manifestService;
        ...
        [HttpPost]
        public JsonResult FilterDistrictById(int parentId)
        {
            if (parentId == 1)
            {
